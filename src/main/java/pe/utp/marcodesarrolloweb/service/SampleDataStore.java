...
public class SampleDataStore {
  ...
  public final Student studentJuan = new Student(1L, "2026-001", "Juan", "Perez", DocumentType.DNI,
    "12345678", "juan.perez@email.com", "987654321", "Av. Lima 123", StudentStatus.ACTIVE,
    LocalDateTime.of(2026, 2, 1, 9, 0));
  
  public final Student studentAna = new Student(2L, "2026-002", "Ana", "Torres", DocumentType.DNI,
    "87654321", "ana.torres@email.com", "912345678", "Jr. Miraflores 456", StudentStatus.ACTIVE,
    LocalDateTime.of(2026, 2, 5, 10, 0));
  
  public final Student studentLuis = new Student(3L, "2025-099", "Luis", "Gomez",
  ...
  public List<Student> students = new ArrayList<>(List.of(studentJuan, studentAna, studentLuis));
